...
public class FaceController_airpressD : MonoBehaviour
{
    ...
    {
        //シリアル通信から空気圧の値を取得
        force = Data_Receiver.GetComponent<receive_data_airpressD>().f_val;
        force_ud = Data_Receiver.GetComponent<receive_data_airpressD>().f_val_ud;
