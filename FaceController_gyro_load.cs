...
public class FaceController_gyro_load : MonoBehaviour
{

    public GameObject Serial_Data;
    public GameObject Serial_Data_load;
    ...
    //load cell
    private float load;
    private float t_load = 1.0f;             //圧力の閾値
    //ローパスフィルタ
    ...
    void Update()
    {
        ...
        //Debug.Log(yaw_angle);
        load = Serial_Data_load.GetComponent<receive_data_load>().load_val;
        //Debug.Log(load);
        ...
        if(f8_flag == true)
        {
            //8. 局所回転：あり（Yaw＋Pitch） / 大域回転：ロードセル閾値（Yawのみ）////////////////////////////
            //閾値調整
