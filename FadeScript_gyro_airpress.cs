...
public class FadeScript_gyro_airpress : MonoBehaviour
{
    ...
    private float max_fade = 0.95f;      //最大のフェード
    ...
    {
        //
        fadein_flag = FaceController.GetComponent<FaceController_gyro_airpress>().fade_in;
        fadeout_flag = FaceController.GetComponent<FaceController_gyro_airpress>().fade_out;
        //フェード機能のオンオフ
